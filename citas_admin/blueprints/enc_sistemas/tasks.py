...
def enviar(enc_sistemas_id):
    ...
    contenidos = [
        ...
        "Le gustaría contestar una encuesta corta de satisfacción para conocer su experiencia con este sistema.<br>" "Sus comentarios nos ayudarían a mejorar nuestro sistema.</p>",
